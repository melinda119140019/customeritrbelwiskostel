...
export default function AboutPage() {
  return (
    <div className="z-50 min-h-screen bg-gradient-to-b from-white via-green-50 to-green-100 flex flex-col">
      ...
      <header className="w-full flex justify-between items-center px-6 md:px-10 py-5 bg-white shadow-sm sticky top-0 z-20">
        ...
        <nav className="hidden md:flex items-center gap-6 text-gray-700 font-medium">
          ...
          <Link href="/learn" className="hover:text-green-700 transition">Pelajari Lebih Lanjut</Link>
          <Link href="/about" className="hover:text-green-700 font-semibold transition">Tentang</Link>
        </nav>
      </header>
      ...
      <main className="flex flex-col md:flex-row items-center justify-between flex-grow px-6 md:px-[8rem] py-20 gap-10">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 leading-snug">
            Tentang ITR HOME STAY
          </h1>

          <p className="text-gray-600 mt-4 text-lg">
            ITR HOME STAY adalah Sistem Informasi Pelaporan Pegawai Negeri di Pengadilan Negeri Sidenreng Rappang.
            Tujuan utama sistem ini adalah mempermudah pegawai dalam melakukan pelaporan kegiatan harian serta meningkatkan transparansi dan efisiensi administrasi.
          </p>

          <ul className="list-disc list-inside text-gray-700 mt-6 space-y-2">
            <li>Meningkatkan akurasi laporan harian</li>
            <li>Mempermudah pemantauan aktivitas pegawai</li>
            <li>Mempercepat proses administrasi</li>
            <li>Memberikan akses mudah untuk informasi dan bantuan</li>
          </ul>
